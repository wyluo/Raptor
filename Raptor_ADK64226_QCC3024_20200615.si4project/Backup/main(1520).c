...
My_hsTaskData My_theSink;//add by lwy 20200615
    ...
    else
    {
        switch(EventPower)
        {
            ...
            case EventSysPowerOnPanic:
                ...
                PioSetPio(AMP,1,1);//add by lwy 20200615
                ...
                //add by lwy 20200615
                //read
                PsRetrieve(PSKEY__USR99, &My_theSink.DA7217_Vol, 3);
                
                DEBUG((">>>>>>>>>>>>>>>>>>>>>> HS: My_theSink.DA7217_Vol= 0x%x \n",My_theSink.DA7217_Vol));
                //DEBUG((">>>>>>>>>>>>>>>>>>>>>> HS: My_theSink.DA7217_EQ= 0x%x \n",My_theSink.DA7217_EQ));
                DEBUG((">>>>>>>>>>>>>>>>>>>>>> HS: My_theSink.time_BToff= 0x%x \n",My_theSink.time_BToff));

				MessageSendLater(&theSink.task, EventUsrGaiaUser5, 0, 500);
                MessageSendLater(&theSink.task, EventUsrGaiaUser20, 0, D_SEC(5));//执行自动关机
                //endof
            ...
            case EventUsrPowerOff:
                ...
                //add by lwy 20200615
            	PioSetPio(AMP, 1, 1);//enable amp

                //write
                PsStore(PSKEY__USR99, &My_theSink.DA7217_Vol, 3);
                ...
                {
                    MessageSendLater(&theSink.task, EventUsrGaiaUser13, 0, D_SEC(2));//add by lwy 20190709                     
                }
                //endof
...
static void handleUEMessage  ( Task task, MessageId id, Message message )
{
    ...
    uint8 payload[1];//add by lwy 20200615
    ...
    { 
        ...
        case EventUsrGaiaUser2: 	  
			PioSetPio(AMP, 1, 1);
			//MAIN_DEBUG(("HS: EventUsrGaiaUser2 enable amp\n" ));
			break;
		
		case EventUsrGaiaUser3:
			DA7217_Volume_Mute();
            MAIN_DEBUG(("HS: EventUsrGaiaUser3 DA7217 Vol Mute\n" ));
			break;
		
		case EventUsrGaiaUser4:
			DA7217_Volume_Mute_Close();
            MAIN_DEBUG(("HS: EventUsrGaiaUser4 DA7217 Vol Close Mute\n" ));
			break;
						
		case EventUsrFmRxOn:
			DA7217VolumeUp();

			payload[0]=My_theSink.DA7217_Vol;
			//MAIN_DEBUG(("HS: EventUsrFmRxOn\n" )) ;
			//MAIN_DEBUG(("HS: My_theSink.DA7217_Vol=0x%d\n",My_theSink.DA7217_Vol )) ;
		...
		case EventUsrGaiaUser6:
			PioSetPio(AMP, 1, 0);// add by lwy disable amp
			MAIN_DEBUG(("HS: EventUsrGaiaUser6 disable AMP\n" ));
			break;
		
		case EventUsrGaiaUser7://universal mode
			//DA7212_UNIVERSAL_Mode();
			//MAIN_DEBUG(("**************HS: EventUsrGaiaUser7_universal)\n" )) ;
			break;
		...
		case EventUsrGaiaUser16:
			//off tone
			break;

		case EventUsrGaiaUser17:
				MessageSendLater(&theSink.task, EventUsrPowerOff, 0, D_MIN(1));//auto power off tone
			break;
		...
		case EventUsrGaiaUser20:
			AVRCP_Update_Sleeptime_NoneVoice();
			break;
        ...
        case (EventUsrEnterPairing):
            ...
            if(id ==EventSysEnterPairingEmptyPDL ) AudioPromptPlayEvent(EventUsrEnterPairing,1);//add by lwy 20200615
        ...
        case (EventUsrResetPairedDeviceList):
            {
                ...
                MessageSendLater(&theSink.task, EventUsrEnterPairing, 0, 500);//add by lwy 20200615
        ...
        case EventSysSLCConnectedAfterPowerOn:
            ...
            MessageSendLater(&theSink.task, EventUsrBleStartBonding, 0, D_SEC(1));//add by lwy 20200615
        break;
       ...
       //case EventUsrFmRxOn://modify by lwy 20200615
       //case EventUsrFmRxOff://modify by lwy 20200615
       //case EventUsrFmRxTuneUp://modify by lwy 20200615
       //case EventUsrFmRxTuneDown://modify by lwy 20200615
